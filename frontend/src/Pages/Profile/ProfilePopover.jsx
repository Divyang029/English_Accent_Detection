...
const ProfilePopover = ({ 
  ...
  setprofileChange,
  userProfile,
  setUserProfile // Make sure this prop is being passed
}) => {
  ...
  const handleEditToggle = () => {
    ...
    if (!isEditMode) {
      ...
      setEditProfile({...localUserProfile});
      setImageFile(null);
    }
  };
    ...
    try {
      ...
      if (formData.has('firstName') || formData.has('lastName') || formData.has('avatar')) {
        ...
        const updatedProfile = {
          ...
          avatar: imageFile ? URL.createObjectURL(imageFile) : localUserProfile.avatar
        };
        ...
        // Trigger the profile change in the parent component
        ...
        {loading ? (
          ...
          <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              <Avatar 
                src={localUserProfile?.avatar || '/default-avatar.png'} 
                sx={{ 
                  width: 80, 
                  height: 80, 
                  mr: 2,
              ...
              <Box>
                <Typography variant="h6" sx={{ color: '#fff' }}>
                  {`${localUserProfile?.firstName || 'Guest'} ${localUserProfile?.lastName || 'User'}`}
                </Typography>
                <Typography variant="body2" sx={{ color: '#9E9E9E' }}>
                  {localUserProfile?.email || 'guest123@gmail.com'}
                </Typography>
              </Box>
            </Box>
