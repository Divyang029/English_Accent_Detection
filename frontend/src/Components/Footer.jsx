...
//                 sx={{ 
//                   fontWeight: 700,
//                   background: 'linear-gradient(45deg, #B0B0B0 30%, #E0E0E0 90%)', // Light gray gradient
//                   WebkitBackgroundClip: 'text',
//                   WebkitTextFillColor: 'transparent',
//                   display: 'inline-block',
//                   mb: 2
...
//                       color: '#9E9E9E',
//                       '&:hover': {
//                         color: '#E0E0E0', // Light gray hover color
//                         bgcolor: 'rgba(224, 224, 224, 0.08)' // Light gray hover background
//                       }
//                     }}
//                   >
//                     {social.icon}
